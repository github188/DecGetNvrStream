...
#if 1
{
	...
	if(0 == strcasecmp(tmpchar, "R9632S") || 0 == strcasecmp(tmpchar, "NR3132") || 0 == strcasecmp(tmpchar, "NR3564"))
	{
...
VD_BOOL CPageSearch::UpdateData( UDM mode )
{
	...
	else if (UDM_CLOSED == mode)
	{
		...
		if((0 == strcasecmp(tmp2, "NR3132")) || (0 == strcasecmp(tmp2, "NR3124")) || 0 == strcasecmp(tmp2, "NR3564"))
		{
