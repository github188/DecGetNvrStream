...
typedef enum
{
	...
	//nvr.cpp 中远程NVR 报警
	EM_ALRM_ALARM_RemoteNVR_VLOST,
	EM_ALRM_ALARM_RemoteNVR_DISK_ERR,
	EM_ALRM_ALARM_RemoteNVR_DISK_LOST,
	
	EM_ALRM_TYPES,//支持的报警种类，必须放在最后一项
}ALARMLISTTYPE;

void AlarmListAdd(u8 chanel,ALARMLISTTYPE cmd,u8 status, const u32 nvrIP = 0);
void AlarmListDelete(u8 chanel,ALARMLISTTYPE cmd,u8 status, const u32 nvrIP = 0);
